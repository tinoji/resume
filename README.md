...
- なんか色々やってきましたが、基本的にはバックエンド(サーバーサイド)エンジニアです。
  - Python, Go, Luaあたりをよく書いていましたが、あまり言語に対する強いこだわりはなく、その都度ベストな言語選定をすることを大切にしています。
...
- 技術的にtoo muchなことをすることはあまり好きではなく、ユーザーファーストを基本にして妥当なアーキテクチャ・実装を探るのが好きです。
  - 技術的に高度なことをしたくないのではなく、事業にコミットすることに重きを置いているという感じです。
  - なので泥臭い仕事も(文句を言いながらですが)しっかりやるタイプだと思っています。
- なにか新しい概念を導入して組織に定着するまでしつこくやる、みたいな動きは比較的得意だと思います。もちろんフィットしないならやめちゃいますが。
- 採用に関わることは結構好きで、得意だと思っています。
  - 登壇などの外部露出も同様です。 
